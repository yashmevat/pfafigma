export default function CafAssessments() {
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      {/* Intro Paragraph */}
      <p className="text-gray-700 text-sm px-5 sm:text-base lg:text-[1.12rem] leading-relaxed mb-10 text-center lg:text-left lg:ml-5">
        ...
        {assessments.map((item, index) => (
          ...
          >
            ...
            <div className="text-left flex-1">
              <h3 className="text-gray-900 font-semibold text-sm sm:text-[1rem] md:text-lg lg:text-[1.4rem]">
                {item.title}
              </h3>
              ...
              <p className="text-gray-600 text-xs sm:text-sm md:text-[15px] lg:text-[1.12rem] leading-relaxed">
                {item.desc}
              </p>
            </div>
          </div>
